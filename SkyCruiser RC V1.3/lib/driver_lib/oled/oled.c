...
static void OLED_Show_Sel_Info(void)
{
...
void OLED_Show_Sel(void)
{
	...
	{
		case 0: OLED_Show_Sel_Info(); break;
		case 1: OLED_Show_euler(); break;
		case 2: OLED_Show_Roll_Pid(); break;
		case 3: OLED_Show_Pitch_Pid(); break;
		case 4: OLED_Show_Yaw_Pid(); break;
	}
}
...
//Ñ­»·ÏÔÊ¾µ÷ÊÔºóµÄpid²ÎÊý
void OLED_Show_Pitch_Pid(void)
{	
	char pitch_core_kp[5] = {0};
	char pitch_core_ki[5] = {0};
	char pitch_core_kd[5] = {0};
	char pitch_shell_kp[5] = {0};
	char pitch_shell_ki[5] = {0};
	
	OLED_ShowString(1,1,(u8*)"Pitch:", 14); 

	//shell
	OLED_ShowString(1,3,(u8*)"sp:", 14);
	itof(ctrl.pitch.shell.kp, pitch_shell_kp);
	OLED_ShowString(24,3,(u8*)pitch_shell_kp, 14);

	OLED_ShowString(1,5,(u8*)"si:", 14);
	itof(ctrl.pitch.shell.ki, pitch_shell_ki);
	OLED_ShowString(24,5,(u8*)pitch_shell_ki, 14);
	
	//core 
	OLED_ShowString(64,3,(u8*)"cp:", 14);
	itof(ctrl.pitch.core.kp, pitch_core_kp);
	OLED_ShowString(88,3,(u8*)pitch_core_kp, 14);

	OLED_ShowString(64,5,(u8*)"ci:", 14);
	itof(ctrl.pitch.core.ki, pitch_core_ki);
	OLED_ShowString(88,5,(u8*)pitch_core_ki, 14);	

	OLED_ShowString(64,7,(u8*)"cd:", 14);
	itof(ctrl.pitch.core.kd, pitch_core_kd);
	OLED_ShowString(88,7,(u8*)pitch_core_kd, 14);	
}

//Ñ­»·ÏÔÊ¾µ÷ÊÔºóµÄpid²ÎÊý
void OLED_Show_Yaw_Pid(void)
{	
	char yaw_core_kp[5] = {0};
	char yaw_core_ki[5] = {0};
	char yaw_core_kd[5] = {0};
	char yaw_shell_kp[5] = {0};
	char yaw_shell_ki[5] = {0};
	
	OLED_ShowString(1,1,(u8*)"yaw: ", 14); 

	//shell
	OLED_ShowString(1,3,(u8*)"sp:", 14);
	itof(ctrl.yaw.shell.kp, yaw_shell_kp);
	OLED_ShowString(24,3,(u8*)yaw_shell_kp, 14);

	OLED_ShowString(1,5,(u8*)"si:", 14);
	itof(ctrl.yaw.shell.ki, yaw_shell_ki);
	OLED_ShowString(24,5,(u8*)yaw_shell_ki, 14);
	
	//core 
	OLED_ShowString(64,3,(u8*)"cp:", 14);
	itof(ctrl.yaw.core.kp, yaw_core_kp);
	OLED_ShowString(88,3,(u8*)yaw_core_kp, 14);

	OLED_ShowString(64,5,(u8*)"ci:", 14);
	itof(ctrl.yaw.core.ki, yaw_core_ki);
	OLED_ShowString(88,5,(u8*)yaw_core_ki, 14);	

	OLED_ShowString(64,7,(u8*)"cd:", 14);
	itof(ctrl.yaw.core.kd, yaw_core_kd);
	OLED_ShowString(88,7,(u8*)yaw_core_kd, 14);	
}
